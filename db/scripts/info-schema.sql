...
-- ('Fu & Friends Example', 'Possumorpheus leans on Fu & Friends during an LHL Race, with commentary from riversmccown and Demerine2', '' 'Video', '1200 strats Fu and Friends Zeromus'), --I think this was intended to have a link, but I don't have it in the prod database, so I either never got it or something weird is going on.
...
('Tallgrant Explains: Relative Agility', 'Tallgrant discusses Relative Agility and the ATB system', 'https://www.youtube.com/watch?v=cAbnhESM6N4&list=PLRXyrx0u7NaXlYCFVw6Mdf0dQaiFpuFoG', 'Video', 'RA Relative Agility Anchor ATB Active Time Battle'),
...
('EEGP Rules Doc', 'Eidolon Express Grand Prix tournament rules document', 'https://docs.google.com/document/d/1N4rFllamPI0XFY19U3nC1elF7Pe7fFhsDL8OwhJAf2Y/edit?tab=t.0#heading=h.puceqeo1f4iq', 'Article', 'EEGP Eidolon Express Grand Prix tournament rules document'),
('Zeromus Script Writeup', 'Wylem wrote a wiki page breaking down the Z script into more understandable phrasing', 'https://wiki.ff4fe.com/doku.php?id=zeromus_script', 'Article', 'Zeromus Script Wiki Boss AI')
('Paladin Cup Rules/Info', 'DrinksGlue presents the Paladin Cup, a periodic series of races for newer players', 'https://docs.google.com/document/d/11Kk_tucAecF7ZUtDZqwVAwju435pC2tC7OPkgziY-r4/edit?tab=t.0', 'Article', 'Paladin Cup New Players'),
('Learningway', 'A short-form course to help very new players get started with Free Enterprise', 'https://info.tellah.life/learningway/', 'Article', 'Learningway newbie new players insruction get started')
;
